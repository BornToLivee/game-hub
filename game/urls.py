...
urlpatterns = [
    ...
    path("ganres/<int:pk>/", views.GenreDetailView.as_view(), name="genre-detail"),
    path("genres/create/", views.GenreCreateView.as_view(), name="genre-create"),
    path("genres/<int:pk>/update/", views.GenresUpdateView.as_view(), name="genre-update"),
    ...
    path("personal_page/", views.PersonalPageView.as_view(), name="personal-page"),
    path("player/update/", views.PlayerUpdateView.as_view(), name="player-update"),
