...
from game.models import Game, Genre, Publisher, Platform, Player
...
class RandomGameViewTestCase(TestCase):
    ...
    def test_random_game_redirects_to_game_detail(self):
        ...
        game_detail_url = reverse('game:game-detail',
                                  kwargs={'pk': self.game1.pk})

        self.assertTrue(redirected_url.endswith(game_detail_url) or redirected_url.endswith(
